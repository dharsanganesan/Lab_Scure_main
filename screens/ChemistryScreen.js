    ...
    const fetchData = async () => {
      ...
      const mockData = [
        { 
          ...
          value: "0.2 ppm", 
          status: "Safe", 
          note: "Within OSHA permissible limits",
          icon: "🧪"
        },
        { 
          _id: "2",
          parameter: "Flammable Materials", 
          value: "3/4 capacity", 
          status: "Warning", 
          note: "Approaching storage limit",
          icon: "🔥"
        },
        { 
          _id: "3",
          ...
          value: "85% efficiency", 
          status: "Safe",
          note: "Optimal airflow maintained",
          icon: "💨"
        },
        { 
          _id: "4",
          parameter: "Eye Wash Station", 
          value: "Ready", 
          status: "Safe",
          note: "Last inspected yesterday",
          icon: "🚰"
        },
        { 
          _id: "5",
          parameter: "Spill Containment", 
          value: "All clear", 
          status: "Safe",
          icon: "⚠️"
        }
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statItem}>
          <Text style={[styles.statValue, {color: "#EF4444"}]}>
            {data.filter(item => item.status === "Danger").length}
          </Text>
